...
While UpdateHub does not collect any personal information, we may collect non-personal information that does not directly identify you for diagnostic purposes. When an error occurs, details such as the operating system, app version, versions of other dependencies such as WinGet, and error information are logged on our server. This information is collected solely to improve the app's functionality and provide a better user experience. The logs are discarded periodically.
...
4. **Contact Us** \
If you have any questions or concerns about this Privacy Policy or the App's privacy practices, please contact us at support@nexova.dev.
